...
function mainPageContent() {
    $.ajax({
        type: "GET",
        url: "http://localhost:3000/text_content",
        dateType: "json",
...
function fullGalleryContent() {
    $.ajax({
        type: "GET",
        url: "http://localhost:3000/image_items",
        dateType: "json",
...
// Вызов случайного json файла в зависимости от рандомного числа
    let randomJson = (Math.random() >= 0.5) ? "http://localhost:3000/success" : "http://localhost:3000/error";
    $.ajax({
        type: "GET",
        url: randomJson,
        dateType: "json",
...
function contactPage() {
    $.ajax({
        type: "GET",
        url: "http://localhost:3000/form_content",
        dateType: "json",
